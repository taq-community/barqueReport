...
The main function generates an interactive HTML report from barque pipeline output:
...
For Illumina quality analysis, provide the `Quality_Metrics.csv` file from your sequencer.
